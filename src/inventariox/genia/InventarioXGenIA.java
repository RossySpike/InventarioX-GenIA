...
public class InventarioXGenIA {
  ...
  public static void main(String[] args) {
     ...
     * Logger.getLogger(InventarioXGenIA.class.getName()).log(Level.SEVERE, null,
     * ex);
     * }
     * pCarga.dispose();
    ...
    c.iniciarPantallaPrincipal(new PantallaPrincipal(listaMed));
    /*
     * 
     * String datoStr;
     * double total;
     ...
     * do {
     * datoStr =
     * Utility.pedirStr("Ingrese el codigo del medicamento (Ej: AB12345678)");
     * if (temp.validarCodigo(datoStr))
     * break;
     * System.out.
     * println("Error! Ingrese el codigo con el formato correcto! (Ej: AB12345678)"
     * );
     * } while (true);
     * 
     ...
     * case 2 -> {
     * datoStr =
     * Utility.pedirStr("Ingrese el nombre del producto que desea buscar");
     ...
     * }
     * }
     * // comparar para la busqueda por codigo en regex por codigo y nombre, comprar
     * y
     * // eliminar
